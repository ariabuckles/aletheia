...
var self = this;
var res = _if(! is_instance(self, ParseNode), (function() {
...
var statement = _if((((expr.type === "unit-list") && (expr.units[0].type === "variable")) && (expr.units[0].name === "ret")), (function() {
return expr;
}), _else, (function() {
return ParseTree.UnitList([ParseTree.Variable("ret"),
expr]);
}));
return new ParseNode({
type: "lambda",
