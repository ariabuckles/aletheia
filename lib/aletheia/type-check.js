...
assert(matchtypes(righttype, vartype), (((((((("Type mismatch: `" + left.name) + "` of type `") + JSON.stringify(vartype)) + "` is incompatible with expression of type `") + JSON.stringify(righttype)) + "`.") + "assignment: ") + JSON.stringify(assign)));
}));
